...
## get the data from website as a shop object 
def get_soup(url) -> BeautifulSoup:
      try:
            ...
            if page.status_code == 200:
                  ...
                  print('errooooorrrr',page.status_code)
      except Exception as e:
            print('errooooorrrr:',e)


# get the list of items from the soup object(important)
def collect_item(soup) -> list:
      try:
            items = soup.find_all('div', class_ = '_1xHGtK _373qXS')
            if len(items) > 0:
                  return items
      except Exception as e:
            print('erroooooorrrr:',e)
